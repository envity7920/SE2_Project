...
<head>
    ...
    <title>Login</title>
    <link href="${url}/css/register_account_style.css" rel="stylesheet" >
    <link href="${url}/css/nav.css" rel="stylesheet" >
      <link href="${url}/css/responsive.css" rel="stylesheet" >
    <!-- <link rel="stylesheet" href="/static/css/register_account_style.css"> -->
                ...
                <div class="main--form">
                    <form class="login--form" method="POST">
                       ...
                       <!--  <div class="wrap--input" data-validate="Username is required">
                            ...
                            <input style="border:none" class="input" type="text" name="username"
                                placeholder="Type your username">
                            <p class="focus--input" data-symbol="&#xf206;"></p>
                        </div> -->
 						<div class="wrap--input" data-validate="Email is required">
                            <p class="label--input">Email</p>
                            <input style="border:none" class="input" type="text" name="email"
                                placeholder="Type your email">
                            <p class="focus--input" data-symbol="&#xf15a"></p>
                        </div>
                        
                        <div class="wrap--input" data-validate="Familyname is required">
                            <p class="label--input">Family name</p>
                            <input style="border:none" class="input" type="text" name="familyName"
                                placeholder="Type your family name">
                            <p class="focus--input" data-symbol="&#xf1f7"></p>
                        </div>

                        <div class="wrap--input" data-validate="Givename is required">
                            <p class="label--input">Given name</p>
                            <input style="border:none" class="input" type="text" name="givenName"
                                placeholder="Type your given name">
                            <p class="focus--input" data-symbol="&#xf1f8"></p>
                        </div>

                       
                        <div class="wrap--input" data-validate="Phone number is required">
                            <p class="label--input">Phone number</p>
                            <input style="border:none" class="input" type="text" name="phoneNumber"
                                placeholder="Eg: +84 999 999 999">
                                
                            <p class="focus--input" data-symbol="&#xf2be"></p>
                        </div>
					...
					<div class="wrap--input" data-validate="Password is required">
                        ...
                        <div class="wrap--input" data-validate=" Repeat password is required">
                            <p class="label--input">Repeat password</p>
                            <input style="border:none" class="input" type="password" name="repeat_password"
                        ...
                        <div class="form--col--content4">
                            <label class="container">
                                <input type="checkbox" checked="checked">
                            </label>
                            <span class="checkmark"><span class="red">*</span>I agree all statements in Term of Service </span>
                        </div>
                        ...
                        <div class="container--login--form--btn">
                            <div class="wrap--login--form--btn">
                                ...
                                <input class="login--form--btn" type="submit"value="Register"/>
                                 <!--    Register -->
